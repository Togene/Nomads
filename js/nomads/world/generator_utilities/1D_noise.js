    ...
    function noise_1D(mapWidth, mapHeight, seed, scale, octaves, persistance, lacunarity, offset){
        ...
        {
            var offsetX = random_range(-100000, 100000) + offset.x;
            var offsetY = random_range(-100000, 100000) - offset.y;
